...
window.ALENINDAHOUSE_CONFIG = {
  ...
  sections: [
    ...
    {id:'cases-section', number:'06', name:'КЕЙСЫ', subtitle:'РЕАЛЬНЫЕ ПРОЕКТЫ И ЦИФРЫ'},
    {id:'quality-section', number:'07', name:'КОНТРОЛЬ / КАЧЕСТВО', subtitle:'КАК КАЧЕСТВО ПРОВЕРЯЕТСЯ'},
    {id:'responsibility-section', number:'08', name:'ЛИЧНОСТЬ / ОТВЕТСТВЕННОСТЬ', subtitle:'КТО ОТВЕЧАЕТ ЗА ОБЪЕКТ'},
    {id:'audit-section', number:'09', name:'АУДИТ СМЕТЫ', subtitle:'ЕСЛИ СМЕТА УЖЕ ЕСТЬ'},
    {id:'contacts-section', number:'10', name:'КОНТАКТЫ', subtitle:'ПЕРВАЯ ВСТРЕЧА БЕЗ ЛИШНЕГО ШУМА'}
  ],
  calculator: {
